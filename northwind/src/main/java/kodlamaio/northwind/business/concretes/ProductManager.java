...
public class ProductManager implements ProductService{
	...
	public DataResult<List<Product>> getByProductNameStartsWith(String productName) {
		...
		return new SuccesDataResult<List<Product>>(this.productDao.getByProductNameStartsWith(productName),"Data Listeleni");
	...
	public DataResult<List<Product>> getByNameAndCategory(String productName, int categoryId) {
		...
		return new SuccesDataResult<List<Product>>(this.productDao.getByNameAndCategory(productName, categoryId),"Data Listeleni");
	...
	public DataResult<List<ProductWithCategoryDto>> getProductWithDetails() {
		...
		return new SuccesDataResult<List<ProductWithCategoryDto>>(this.productDao.getProductWithDetails(),"Data Listelendi");
	}	
